...
export const translations = {
  tr: {
    ...
    adminPage: {
      ...
      description:
        "Fuar yönetimi, kategori düzenleme ve içerik onay süreçleri sonraki aşamalarda buraya eklenecek.",
      modulesTitle: "Yönetim modülleri",
      fairsModule: "Fuarlar",
      categoriesModule: "Kategoriler",
      usersModule: "Kullanıcılar",
      viewFairs: "Fuarları görüntüle",
    },
    footer: {
      tagline:
  ...
  en: {
    ...
    adminPage: {
      ...
      title: "Admin panel",
      description:
        "Fair management, category editing, and content approval flows will be added here in later stages.",
